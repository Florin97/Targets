...
let facebookPackages = [
    ServicePackage(id: "fb1", channelID: "1", price: 299.0, benefits: ["Ad Listings", "Campaign Optimization", "Monthly Reports"]),
    ServicePackage(id: "fb2", channelID: "1", price: 349.0, benefits: ["Advanced Targeting", "Conversion Tracking"]),
    ServicePackage(id: "fb3", channelID: "1", price: 349.0, benefits: ["Advanced Targeting", "Conversion Tracking"]),
    ServicePackage(id: "fb4", channelID: "1", price: 349.0, benefits: ["Advanced Targeting", "Conversion Tracking"]),
    ServicePackage(id: "fb5", channelID: "1", price: 349.0, benefits: ["Advanced Targeting", "Conversion Tracking"])
]
